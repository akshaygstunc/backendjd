...
const resposne = {
  ...
  sendError: "Error while sending OTP to email.",
  ...
  nodataDownload: "No Award data available to export",
  ...
  usercreate: 'User successfully created. Please check your email to verify your account.',
  userlginsuccess: "User Login Success",
  usercreateEmailFail: 'Error sending verification email. Please try again later.',
  ...
  ScoreCardFail: "Failed to Create Scorecard",
  ...
  juryAssignwithemail: "Jury Assigned and Email sent Successfully",
  ...
  invalidroundId: "Invalid Round ID Or not Found",
  invalidScoreFormId: "Invalid scoreFormId Or not Found",
  scorecardwithCategory: "Scorecard and categories created successfully",
  scorecardwithCategoryfail: "Failed to add categories to scorecard",
  scoreFormcardUpdated: "scorecard form updated successfully",
  scoreforcardalreadyDeleted: "Scorecard already deleted",
  scorecardDeleteFail: "Failed to delete the scorecard",
  scorecardDeleteSuccess: "Scorecard deleted successfully",
  invalidJuryAssignId: "Invalid JuryAssign Id or not found",
  errCreateJuryGrp: "Error while adding jury group name.",
  assignUpdateSuccess: "Assign jury updated successfully.",
  assignUpdateFail: "Failed to update the assign jury.",
  juryDeleteSuccess: "Jury deleted successfully",
  juryDeletefail: "Error deleting the jury assignment.",
  scrcardCatgryFail: "Failed to insert scorecard categories",
  scrcrdUpdateSuccess: "Scorecard updated successfully",
  scrcrdUpdatefail: "Failed to update the scorecard",
  scrcrdAlrdyDeleted: "scorecard categories already deleted ",
  invalidUserId: "Invalid userId. User does not exist.",
  invalidAdminId: "Invalid adminId. Admin does not exist.",
  regformDataSubSuccess: "Registration Form submission successful.",
  regformDataSubfail: "Registration Form submission failed.",
  entryformDataSubSuccess: "Entry Form submission successful.",
  entryformDataSubfail: "Entry Form submission failed.",
  EnteryDataSuccess: 'Entry data submitted successfully.',
  EntryDataSaveFail: 'Failed to save entry data.',
  noProvidedfield: 'No fields provided.',
  SubIDGenail: 'Failed to generate submission ID.',
  invldEntryFormID: 'Invalid entry form ID.',
  shortlistDeleteSuccess: "shortlist deleted successfully",
  shortlistDeletefail: "Error deleting the shotlisted data.",
  invalidsubmissionId: "Invalid or already deleted submission_ids provided",
  RegistrationDataUpSuccess: "Registration data updated successfully",
  EntryDataUpSuccess: "Entry data updated successfully",
  noRegDataAvail: "No registration data available",
  noEntryDataAvail: "No entry data available",
  formAlreadyExists: "Registration Form already exists with this EventId",
  entryformAlreadyExists: "Entry Form already exists with this EventId",
  alljuryGroupFetchSuccess: "Jury groups fetched successfully",
  groupIdfail: "Invalid Group Id or not Found.",
  roundIdfail: "Invalid Round Id or not Found.",
  deletebackdoorError: "Error Occured while deleting the backdoor",
  backdoorDeleteSuccess: "Backdoor Deleted Successfully",
  usercreatefail: 'User registration failed. Please try again.',
  userVerifySuccess:"User verified successfully.",
  userVerifyFalse:"Error while verifying user.",
  invldadminEvent:"Invalid admin ID or not authorized to access this event.",
  backdoorUnAvail:"Backdoor not available for this event.",
  blockingError:"Error while blocking the user.",
  blockingSuccess:"User blocked successfully.",
  adminNotFound : "Admin not found",
  adminBlocked: "Admin blocked successfully",
  userUnblockedSuccessfully: "User unblocked successfully",
  youareblocked: "You are blocked by admin",
  juryMailFail: "Already assigned this round to jury email you provided",
  judgescored:"judge score saved successfully",
  judgeIdfail: "Invalid Judge Id or not Found.",
}
